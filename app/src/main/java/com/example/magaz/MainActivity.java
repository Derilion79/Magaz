...
import com.example.magaz.adapter.CategoryAdapter;
import com.example.magaz.adapter.CourseAdapter;
import com.example.magaz.model.Category;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void pronas(View view){
        Intent intent = new Intent(this, Pronas.class);
        startActivity(intent);
    }
    public void konta(View view){
